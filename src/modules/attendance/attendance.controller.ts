...
export class AttendanceController {
  ...
  @ApiOperation({ summary: 'Lister les pointages (filtrable par équipe, utilisateur, date, statut)' })
  ...
  @ApiOperation({ summary: 'Résumé journalier par équipe (présents/absents/retards/congés)' })
  ...
  @Post()
  @Roles(UserRole.ADMIN, UserRole.CHEF_PROJET, UserRole.CONDUCTEUR_TRAVAUX, UserRole.COLLABORATEUR)
  @ApiOperation({ summary: 'Créer un pointage (présence/absence/retard/congé)' })
  @ApiResponse({ status: 201, description: 'Pointage créé' })
  @ApiResponse({ status: 409, description: 'Pointage déjà existant pour cette date' })
